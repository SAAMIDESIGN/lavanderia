...
if ($_POST['action'] == 'addCliente') {
  ...
  $profesion = $_POST['pro_cliente'];
  $usuario_id = $_SESSION['idUser'];

  $query_insert = mysqli_query($conexion, "INSERT INTO cliente(dni, nombre, telefono, direccion, profesion, usuario_id) VALUES ('$dni','$nomnre','$telefono','$direccion','$profesion','$usuario_id')");
  if ($query_insert) {
...
if ($_POST['action'] == 'addProductoDetalle') {
  if (empty($_POST['producto']) || empty($_POST['cantidad'])){
    ...
    $query_detalle_temp = mysqli_query($conexion, "CALL add_detalle_temp ('$codproducto','$cantidad','$observacion','$token')");
