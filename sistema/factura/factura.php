		...
		<table id="factura_head">
			<tr>
				<td class="logo_factura">
					<div>
						<img src="img/Imagen2.png" style="width: 90px;">
					</div>
				</td>
				...
				<td class="info_factura">
					<div class="round">
						...
						<p>N°. Factura: <?php echo $factura['nofactura']; ?></strong></p>
		...
		<table id="factura_detalle">
			<thead>
				<tr>
					...
					<th class="textleft">Tipo de Prenda</th>
			...
			<tfoot id="detalle_totales">
				<tr>
					<td colspan="4" class="textright"><span>SUBTOTAL S/.</span></td>
					<td class="textright"><span><?php echo $impuesto; ?></span></td>
				</tr>
				<tr>
					<td colspan="4" class="textright"><span>IGV (<?php echo $iva; ?> %)</span></td>
					<td class="textright"><span><?php echo $tl_sniva; ?></span></td>
				</tr>
				<tr>
					<td colspan="4" class="textright"><span>TOTAL S/.</span></td>
