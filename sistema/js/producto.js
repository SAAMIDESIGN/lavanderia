...
$('.btn_new_cliente').click(function(e) {
  ...
  $('#pro_cliente').removeAttr('disabled');
  ...
  $.ajax({
    ...
    success: function(response) {
      if (response == 0) {
        ...
        $('#pro_cliente').val(data.profesion);
        ...
        $('#pro_cliente').attr('disabled','disabled');
...
$('#add_product_venta').click(function(e) {
  ...
  if ($('#txt_cant_producto').val() > 0) {
    ...
    $.ajax({
      ...
      type: 'POST',
      async: true,
      data: {action:action,producto:codproducto,cantidad:cantidad, observacion:observacion},
      success: function(response) {
